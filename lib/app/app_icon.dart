...
abstract class AppIcon {
  ...
  static AppIconBuilder get placeholder =>
  ...
  static AppIconBuilder get icSwitchOff =>
      AppIconBuilder('${_assetPath}ic_switch_off.svg');

  static AppIconBuilder get icSwitchOn =>
      AppIconBuilder('${_assetPath}ic_switch_on.svg');

  static AppIconBuilder get icCamera =>
      AppIconBuilder('${_assetPath}ic_camera.svg');

  static AppIconBuilder get icMoreAction =>
      AppIconBuilder('${_assetPath}ic_more_action.svg');

  static AppIconBuilder get icHistory =>
      AppIconBuilder('${_assetPath}ic_history.svg');

  static AppIconBuilder get icDelete =>
      AppIconBuilder('${_assetPath}ic_delete.svg');
...
class ImageBuilder extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    if (borderRadius != null) {
      return ClipRRect(borderRadius: borderRadius!, child: _image());
    }
    return _image();
  }
    ...
    try {
      ...
      if (isNetworkMedia) {
        return SizedBox(
          width: width,
          height: height,
          child: Image.network(input, fit: BoxFit.cover),
        );
      }
      return Image(
